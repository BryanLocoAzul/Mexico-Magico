...
class PlazuelasMap extends StatefulWidget {
  const PlazuelasMap({Key? key}) : super(key: key);

  @override
  _PlazuelasMapState createState() => _PlazuelasMapState();
}

class _PlazuelasMapState extends State<PlazuelasMap> {
  CustomInfoWindowController _customInfoWindowController =
      CustomInfoWindowController();
  final LatLng _origin = LatLng(20.41936032792878, -101.72193084970823);
  final LatLng _destination = LatLng(20.404747583479658, -101.82678021902733);
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(
                              'https://cultura.guanajuato.gob.mx/wp-content/uploads/2017/02/plazuela_1.jpg',
                            ),
                            fit: BoxFit.fitWidth,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(
                              'https://img.chilango.com/2023/01/tortas-gigantes-cdmx-1024x576.png',
                            ),
                            fit: BoxFit.fitWidth,
                            filterQuality: FilterQuality.high,
                          ),
