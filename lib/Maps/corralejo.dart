...
class Corralejomap extends StatefulWidget {
  const Corralejomap({Key? key}) : super(key: key);

  @override
  _CorralejomapState createState() => _CorralejomapState();
}

class _CorralejomapState extends State<Corralejomap> {
  CustomInfoWindowController _customInfoWindowController =
      CustomInfoWindowController();
  final LatLng _origin = LatLng(20.50806545406823, -101.62952991661726);
  final LatLng _destination = LatLng(20.50068316956966, -101.62920753621135);
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(
                              'https://www.granmexico.com/wp-content/uploads/2020/09/Corralejo_Hacienda.jpg',
                            ),
                            fit: BoxFit.fitWidth,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(
                              'https://neuromarketing.la/web/wp-content/uploads/2017/10/decoracion-de-tiendas-neuromarketing-sentidos.jpg',
                            ),
                            fit: BoxFit.fitWidth,
                            filterQuality: FilterQuality.high,
                          ),
